...
function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (password.length < 12) {
      toast.error("A senha precisa ter no mínimo 12 caracteres");
      return;
    }
    setLoading(true);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={loading}
        className="mt-6 inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg border border-border bg-background text-sm font-medium hover:bg-secondary disabled:opacity-50"
      >
        <GoogleIcon />
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label className="mt-5 flex items-start gap-2 text-sm">
          ...
          <span className="text-muted-foreground">
            Concordo com os{" "}
            <a className="text-foreground underline-offset-4 hover:underline">termos de uso</a>{" "}
            e a{" "}
            <a className="text-foreground underline-offset-4 hover:underline">política de privacidade</a>.
          </span>
        </label>
        ...
        <button
          ...
          className="mt-6 inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-foreground text-sm font-medium text-background transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
        >
