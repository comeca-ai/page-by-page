        ...
        <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center">
          {!sent ? (
            <form onSubmit={handleSubmit}>
              <h1 className="text-3xl font-semibold tracking-tight">Esqueceu a senha?</h1>
              <p className="mt-2 text-sm text-muted-foreground">
                Sem problema. A gente te manda um link pra criar uma nova em segundos.
              </p>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex h-11 items-center gap-1.5 rounded-lg bg-foreground px-4 text-sm font-medium text-background hover:opacity-90 disabled:opacity-50"
                >
                  {loading ? <Loader2 className="h-4 w-4 animate-spin" /> : <>Enviar <ArrowRight className="h-4 w-4" /></>}
                </button>
              </div>
            ...
            <div>
              ...
              <h1 className="mt-6 text-3xl font-semibold tracking-tight">Confira seu e-mail</h1>
              <p className="mt-2 text-sm text-muted-foreground">
                Mandamos um link de recuperação pra{" "}
                <span className="font-medium text-foreground">{email}</span>. Pode demorar um minutinho pra chegar.
              </p>
              ...
              <div className="mt-8 rounded-lg border border-border bg-secondary/40 p-4 text-xs text-muted-foreground">
                ...
                <button onClick={() => setSent(false)} className="font-medium text-foreground underline-offset-4 hover:underline">
                  tente outro e-mail
                </button>.
              </div>
        ...
        <div className="relative flex h-full items-center justify-center p-12">
          <div className="max-w-md space-y-6">
            <div className="rounded-2xl border border-border bg-background p-6 shadow-sm">
              <div className="text-xs uppercase tracking-widest text-muted-foreground">Dica rápida</div>
              <div className="mt-2 text-xl font-semibold tracking-tight">Use um gerenciador de senhas</div>
              <p className="mt-2 text-sm text-muted-foreground">
                A gente recomenda 1Password ou Bitwarden pro seu time. Mais segurança, menos esquecimento.
              </p>
            </div>
          </div>
        </div>
